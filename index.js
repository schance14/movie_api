...
let movies = [
  {
    ...
    Director: {
      ...
      Description:
        "Catherine grew up in the Texas border town of McAllen. She studied art in Mexico, then received a degree in architecture from the University of Texas at Austin. She began her career by designing a solar townhouse complex, but soon decided that film was her true calling.",
  ...
  },
  {
    ...
    Description:
      " A meek Hobbit from the Shire and eight companions set out on a journey to destroy the powerful One Ring and save Middle-earth from the Dark Lord Sauron. This movie is adapted from the novel of the same name and shows a different world where different types of creatures live.",
    Genre: {
      Name: "Fantasy",
      Description:
    ...
    Director: {
      Name: "Peter Jackson",
      Description:
        "Peter Jackson is a New Zealand film director, producer, actor, and screenwriter, known for his Lord of the Rings film trilogy, adapted from the novel by J. R. R. Tolkien. He is also known for his 2005 remake of King Kong and as the producer of District 9.",
  ...
  },
  {
    ...
    Director: {
      Name: "Alfonso Cuarón",
      Description:
        "Alfonso Cuarón Orozco is an Academy Award-nominated Mexican film director, screenwriter and film producer, best known for, Children of Men, Harry Potter and the Prisoner of Azkaban, Y tu mamá también, and A Little Princess. Cuarón was born in México City.",
  ...
  },
  {
    ...
    Director: {
      Name: "Trey Parker",
      Description:
        " American screenwriter, actor, and producer, best known as the cocreator, with Matt Stone, of the subversive animated comedy series South Park.",
  ...
  },
  {
    ...
    Director: {
      Name: "Ben Stiller",
      Description:
        "Benjamin Edward Meara Stiller is an American actor, comedian, and filmmaker. He is the son of the comedians and actors Jerry Stiller and Anne Meara.",
  ...
  },
  {
    Title: "Mean Girls",
    Description:
      "The plot centers on naïve teenage girl Cady Heron navigating her way through the social hierarchy of a modern American high school after years of her parents homeschooling her while conducting research in Africa.",
    Genre: {
      Name: "Comedy",
      Description:
        "Comedies are light-hearted dramas, crafted to amuse, entertain, and provoke enjoyment.",
    ...
    Director: {
      Name: "Mark Waters",
      Description:
        "Mark Stephen Waters is an American film director and producer. Waters is perhaps best known for directing Just Like Heaven, Freaky Friday, and Mean Girls, and producing 500 Days of Summer.",
  ...
  },
  {
    ...
    Genre: {
      Name: "Slasher",
      Description:
        "A slasher movie is a horror sub-genre that involves the murdering of a number of people by a psychopathic killer, typically via a knife or bladed tool (such as a scythe). In general, the horror genre is known for its fear, violence and terror.",
    },
    Director: {
      Name: "Wes Craven",
      Description:
        "Wesley Earl Craven was an American film director, screenwriter, producer, actor, and editor. Craven has commonly been recognized as one of the greatest masters of the horror genre due to the cultural impact and influence of his work.",
      Birth: " August 2, 1939",
